...
class BackendAuthDataSourceImpl implements BackendAuthDataSource {
  ...
  Future<T> _guard<T>(Future<T> Function() action) async {
    try {
      ...
      // `displayMessage` is allowed to come from (ADR-0017 D2, Amendment 1
      // A1-D1: `AuthException.fromEnvelope` is the only constructor able to
      ...
      if (envelope != null) {
        throw AuthException.fromEnvelope(
          envelope,
